    ...
    <div className="bg-white/55 backdrop-blur-2xl backdrop-saturate-150 ring-1 ring-white/60 shadow-[0_8px_32px_-12px_rgba(15,23,42,0.10)] rounded-3xl p-5">
      <div className="flex items-center justify-between mb-1">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 text-white rounded-xl text-xs hover:bg-emerald-700 shadow-[0_4px_12px_-2px_var(--accent-shadow-sm)] ring-1 ring-white/10 transition-all transition-colors"
        >
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={creating}
              className="px-3 py-1.5 bg-emerald-600 text-white rounded-xl text-xs hover:bg-emerald-700 shadow-[0_4px_12px_-2px_var(--accent-shadow-sm)] ring-1 ring-white/10 transition-all transition-colors disabled:opacity-50"
            >
