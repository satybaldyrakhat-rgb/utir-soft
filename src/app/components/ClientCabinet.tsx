      ...
      <div className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_4px_24px_rgba(15,118,110,0.05)] p-4 hover:shadow-sm transition-shadow space-y-4">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex gap-2">
            ...
            <button className="flex items-center gap-1.5 px-3 py-2 bg-emerald-600 text-white rounded-2xl text-xs hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all transition-colors">
  ...
  return (
    <div className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_4px_24px_rgba(15,118,110,0.05)] overflow-hidden hover:shadow-sm transition-shadow">
      ...
      <div className="p-4 space-y-3">
        ...
        <button onClick={onOpen} className="w-full mt-2 py-2 bg-emerald-600 text-white rounded-2xl text-xs hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all flex items-center justify-center gap-1.5 transition-colors">
          ...
          return (
            <div key={d.id} className="group bg-white/60 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_4px_24px_rgba(15,118,110,0.05)] overflow-hidden hover:shadow-sm transition-all">
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button className="flex-1 py-2 bg-emerald-600 text-white rounded-2xl text-xs hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all transition-colors">{tl(lang, 'Открыть', 'Ашу', 'Open')}</button>
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_4px_24px_rgba(15,118,110,0.05)] p-5">
          ...
          <div className="mt-6 space-y-2">
            ...
            <button className="w-full flex items-center justify-center gap-2 py-2.5 bg-emerald-600 text-white rounded-2xl text-xs hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all transition-colors">
        ...
        {deals.slice(0, 2).map((d, idx) => (
          <div key={d.id} className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_4px_24px_rgba(15,118,110,0.05)] overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex gap-2">
                <button className="flex-1 py-2.5 bg-emerald-600 text-white rounded-2xl text-xs hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all transition-colors">{tl(lang, 'Открыть AR', 'AR ашу', 'Open AR')}</button>
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_4px_24px_rgba(15,118,110,0.05)] overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex gap-2">
            <button className="flex-1 py-2.5 bg-emerald-600 text-white rounded-2xl text-xs hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all transition-colors">{tl(lang, 'Опубликовать', 'Жариялау', 'Publish')}</button>
