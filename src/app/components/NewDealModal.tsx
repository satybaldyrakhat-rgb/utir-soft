  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white/80 backdrop-blur-2xl backdrop-saturate-150 border border-white/70 rounded-3xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-[0_24px_64px_-12px_rgba(15,23,42,0.3)] overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="px-6 py-4 border-t border-white/60 flex items-center gap-2 flex-shrink-0 flex-wrap">
          ...
          {tab < 3 ? (
            <button
              ...
              disabled={!canNext}
              className="px-4 py-2 bg-slate-900/95 text-white rounded-2xl text-xs hover:bg-slate-900 flex items-center gap-1 shadow-[0_8px_24px_-8px_rgba(15,23,42,0.4)] ring-1 ring-white/10 disabled:opacity-40 disabled:shadow-none transition-all"
            >
            ...
            <button
              ...
              disabled={!client.name}
              className="px-4 py-2 bg-slate-900/95 text-white rounded-2xl text-xs hover:bg-slate-900 shadow-[0_8px_24px_-8px_rgba(15,23,42,0.4)] ring-1 ring-white/10 disabled:opacity-40 disabled:shadow-none transition-all"
            >
