        ...
        <div className="bg-white/60 ring-1 ring-white/60 backdrop-blur-xl rounded-2xl p-8 text-center">
          ...
          {!metaConnected ? (
            <button
              ...
              className="px-5 py-2.5 bg-emerald-600 text-white rounded-2xl text-sm hover:bg-emerald-700 shadow-[0_8px_24px_-8px_var(--accent-shadow)] ring-1 ring-white/10 transition-all"
            >
              Подключить Meta Ads
            </button>
          ) : (
